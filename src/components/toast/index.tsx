      ...
      (t) => (
        ...
        >
          ...
          <button
            ...
            className="shrink-0 w-5 h-5 text-muted-foreground hover:text-foreground transition-colors duration-200 hover:bg-muted/50 rounded flex items-center justify-center"
          >
            <X className="w-3 h-3" />
          </button>
        </div>
